...
class APIClient:
    ...
    def get_anxiety_trends(self, time_range: str = "week") -> Dict[str, Any]:
        ...
        params = {"time_range": time_range}
        return self._make_request("GET", "/analytics/user/anxiety-trends", params=params)
    
    def get_conversation_patterns(self, time_range: str = "week") -> Dict[str, Any]:
        """Get conversation patterns"""
        params = {"time_range": time_range}
        return self._make_request("GET", "/analytics/user/conversation-patterns", params=params)
    
    def get_worry_categories(self, time_range: str = "week") -> Dict[str, Any]:
        """Get worry categories breakdown"""
        params = {"time_range": time_range}
        return self._make_request("GET", "/analytics/user/worry-categories", params=params)
    ...
    def get_agent_performance(self, time_range: str = "day", agent_name: str = None) -> Dict[str, Any]:
        """Get agent performance metrics"""
        params = {"time_range": time_range}
        if agent_name:
            params["agent_name"] = agent_name
        return self._make_request("GET", "/analytics/system/agent-performance", params=params)
    ...
    def export_user_data(self, format: str = "json", time_range: str = "all") -> Any:
        ...
        if format == "json":
            return self._make_request("GET", "/analytics/export/user-data", params=params)
        else:
    ...
    def get_anxiety_prediction(self, hours_ahead: int = 24) -> Dict[str, Any]:
        ...
        return self._make_request("GET", "/analytics/insights/prediction", params=params)
